...
export default function Shops() {
  ...
  function getDatas() {
    axios.get('http://localhost/reactcrud/Shop/shop_list.php')
  ...
  const handleSubmit = (event) => {
    ...
    axios.post('http://localhost/reactcrud/Shop/shop_create.php', inputs)
      .then(function (response) {
  ...
  function getProductEdit(id) {
    document.getElementById('modelbutton').click();
    axios.get(`http://localhost/reactcrud/Shop/shop_edit.php?id=${id}`)
      .then(function (response) {
  ...
  const deleteUser = (id) => {
    ...
    if (confirmDelete) {
      axios
        .delete(`http://localhost/reactcrud/Shop/shop_delete.php?id=${id}`)
        .then(function (response) {
          getDatas();
        });
    }
      ...
      <div className="row">
        ...
        <div className="col-9 mt-2">
          <h1 className="text-center bg-success rounded" width="400" height="300">
            <small className="text-white">Our Products</small>
          </h1>
          <button
            onClick={clearData}
            id="modelbutton"
