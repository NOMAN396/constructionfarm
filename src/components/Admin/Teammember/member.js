...
export default function Teammember() {
  ...
  function getDatas() {
    axios.get('http://localhost/reactcrud/Teammember/member_list.php')
  ...
  const handleSubmit = (event) => {
    ...
    axios.post('http://localhost/reactcrud/Teammember/member_create.php', inputs)
      .then(function (response) {
  ...
  function getProductEdit(id) {
    document.getElementById('modelbutton').click();
    axios.get(`http://localhost/reactcrud/Teammember/member_edit.php?id=${id}`)
      .then(function (response) {
  ...
  const deleteUser = (id) => {
    ...
    if (confirmDelete) {
      axios
        .delete(`http://localhost/reactcrud/Teammember/member_delete.php?id=${id}`)
        .then(function (response) {
          getDatas();
        });
    }
