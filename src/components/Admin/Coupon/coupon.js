...
function Coupon() {
    ...
    function getDatas() {
        axios.get('http://localhost/reactcrud/crud_coupon/index_coupon.php').then(function (response) {
            setCouponData(response.data.data);
        });
    }
    const deleteItem = (id) => {
        axios.delete(`http://localhost/reactcrud/crud_coupon/delete_coupon.php?id=${id}`).then(function () {
            getDatas();
        });
    }
    const clearData = () => {
    ...
    function getCouponData(id) {
        ...
        axios.get(`http://localhost/react_ashion/reactcrud/single_coupon.php?id=${id}`).then(function (response) {
    ...
    const handleSubmit = (event) => {
        ...
        axios.post('http://localhost/reactcrud/crud_coupon/create_coupon.php', inputs).then(function (response) {
